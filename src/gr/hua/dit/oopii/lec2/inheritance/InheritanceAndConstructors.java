...
public class InheritanceAndConstructors extends Callculator {	//The father constructor has been overloaded with different arguments of (0,1, or 2).

	
	InheritanceAndConstructors(String name2){ // Constructor with one argument
		super(name2,1); //By default we call the default super-class constructor. 
		System.out.println("second_class constructor!"); //But, we can  explicitly select a different super-class constructor.
	}
	...
	public static void main(String[] args ){
		InheritanceAndConstructors child1 = new InheritanceAndConstructors("child1");
